export const EN_OPERATIONAL_MESSAGES = {
  ...
  "ingest.custom": "Custom",
  "ingest.custom_help": "Use a custom source for any service that can send a JSON webhook.",
  "ingest.add_source": "Add source",
  "ingest.source_id": "Source ID",
  "ingest.source_id_help": "Choose a stable lowercase ID using letters, digits and single hyphens (for example home-assistant).",
  "ingest.display_name": "Display name",
  "ingest.display_name_help": "Choose the readable name shown in the flow and delivery views.",
  "ingest.remove": "Remove",
  "ingest.remove_confirm": "Remove custom source {source}? Its webhook endpoint and stored secret will stop working.",
  "ingest.copy_secret": "Copy this secret into the {source} emitter now. It will not be shown again. Endpoint: {endpoint}",
  ...
  "ingest.added": "Custom source {source} added.",
  "ingest.removed": "Custom source {source} removed.",
