...
(function () {
  ...
  const M = {
    en: {
      ...
      "footer.byline": "by Luigi Barretta",
      ...
      "legal.notice.body": `<p><strong>Application:</strong> klaxond</p><p><strong>Operator:</strong> Luigi Barretta</p><p><strong>Site:</strong> <code>klaxond.luigibarretta.com</code></p><p>This deployment is an administrative console for alert routing and notification delivery. It is not intended to be a marketplace, social network, advertising platform or user-generated content hosting service.</p><p>For privacy, accessibility, security or legal requests, use the established operational contact for this deployment and include enough detail to identify the affected account, URL, request ID or timestamp.</p>`,
    ...
    it: {
      ...
      "legal.notice.body": `<p><strong>Applicazione:</strong> klaxond</p><p><strong>Operatore:</strong> Luigi Barretta</p><p><strong>Sito:</strong> <code>klaxond.luigibarretta.com</code></p><p>Questo deployment e' una console amministrativa per routing alert e consegna notifiche. Non e' pensato come marketplace, social network, piattaforma pubblicitaria o servizio di hosting per contenuti generati dagli utenti.</p><p>Per richieste privacy, accessibilita', sicurezza o legali, usa il contatto operativo stabilito per questo deployment e includi dettagli sufficienti a identificare account, URL, request ID o timestamp interessati.</p>`,
