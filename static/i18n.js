...
(function () {
  ...
  const M = {
    en: {
      ...
      "auth.bcrypt_warn": "bcrypt support is unavailable — local basic auth will fail",
    ...
    it: {
      ...
      "auth.bcrypt_warn": "Supporto bcrypt non disponibile — la basic auth locale fallirà",
