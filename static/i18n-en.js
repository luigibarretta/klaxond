...
const EN_STATIC_MESSAGES = {
  ...
  "setup.detail.ingest_auth.warn": "No inbound sources have a shared secret ({configured}/{total}).",
  "setup.detail.ingest_auth.partial": "Only {configured}/{total} inbound sources are protected.",
  "setup.detail.ingest_auth.ok": "All {total} inbound sources are protected.",
