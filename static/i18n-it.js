...
const IT_STATIC_MESSAGES = {
  ...
  "setup.detail.ingest_auth.warn": "Nessuna sorgente in ingresso ha un segreto condiviso ({configured}/{total}).",
  "setup.detail.ingest_auth.partial": "Solo {configured}/{total} sorgenti in ingresso sono protette.",
  "setup.detail.ingest_auth.ok": "Tutte le {total} sorgenti in ingresso sono protette.",
